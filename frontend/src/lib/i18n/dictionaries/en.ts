export const en = {
  ...
  demoDataBannerText: "This content is illustrative only and is not connected to live operations.",
  demoConversationBannerText: "These messages are illustrative demo history, not a real conversation.",
  notYetComputed: "Not yet computed. Connect real operational data to populate this view.",
  you: "You",
  ...
  noFilesYetText: "Upload a company file to see it listed here.",
  ...
  recordDecisionPermissionDenied: "You don't have permission to record decisions.",
  recordDecisionReceiptUnavailable: "This response is no longer available to record a decision against.",
  recordDecisionInvalid: "Please enter a decision.",
  recordDecisionFailed: "Unable to record decision. Please try again.",
  ...
  recordAnotherOutcome: "Record another outcome",
  recordingOutcome: "Recording...",
  recordOutcomePermissionDenied: "You don't have permission to record outcomes.",
  recordOutcomeDecisionUnavailable: "This decision is no longer available to record an outcome against.",
  recordOutcomeInvalid: "Please check the outcome details.",
  recordOutcomeFailed: "Unable to record outcome. Please try again.",
  actionsTitle: "Actions",
  createAction: "Create Action",
  actionTitleLabel: "Title",
  actionInstructionsLabel: "Instructions (optional)",
  creatingAction: "Creating...",
  createActionPermissionDenied: "You don't have permission to create actions.",
  createActionDecisionUnavailable: "This decision is no longer available to create an action against.",
  createActionInvalid: "Please enter a title for this action.",
  createActionFailed: "Unable to create action. Please try again.",
  loadingActions: "Loading actions...",
  unableLoadActions: "Unable to load actions.",
  noActionsYet: "No actions recorded for this decision yet.",
  actionUnassigned: "Unassigned",
  actionAssigned: "Assigned",
  unassignAction: "Unassign",
  unassigningAction: "Unassigning...",
  unassignActionFailed: "Unable to unassign this action. Please try again.",
  ...
  updatingActionStatus: "Updating...",
  actionStatusUpdateFailed: "Unable to update this action's status. Please try again.",
  actionConflict: "This action was already updated by someone else. Refreshing...",
  actionNotFound: "This action is no longer available.",
  viewActionHistory: "View history",
  hideActionHistory: "Hide history",
  actionHistoryTitle: "History",
  loadingActionHistory: "Loading history...",
  unableLoadActionHistory: "Unable to load action history.",
  actionStatusChangeLabel: "Status",
  actionAssignmentChangeLabel: "Assignment",
  actionChangedByTeamMember: "by a team member",
  actionChangedByPrefix: "by",
  actionStatusInitial: "Initial",
  actionAssignedFallback: "Assigned team member",
  assigneeLabel: "Assignee",
  loadingMembers: "Loading members...",
  unableLoadMembers: "Unable to load company members.",
  ...
  companyInputs: {
    ...
    executivePriorityAttentionLevel: "Attention Level",
    executivePrioritySituation: "Situation",
    executivePriorityBusinessRisk: "Business Risk",
    executivePriorityTrigger: "Executive Trigger",
    executiveSummary: "Executive Summary",
    whatChanged: "What Changed?",
    factsTruthLayer: "Facts (Truth Layer)",
    executiveAssessment: "Executive Assessment",
    executiveAssessmentInterpretation: "Executive Interpretation",
    executiveAssessmentBusinessMeaning: "Business Meaning",
    executiveAssessmentRecommendationContext: "Executive Recommendation Context",
    businessImpact: "Business Impact",
    businessImpactOperational: "Operational Impact",
    businessImpactFinancial: "Financial Impact",
    businessImpactFinancialUnknown: "Unknown",
    businessImpactStrategic: "Strategic Impact",
    recommendedExecutiveActions: "Recommended Executive Actions",
    executiveActionPriority: "Priority",
    executiveActionReason: "Reason",
    executiveActionEvidence: "Evidence",
    executiveActionExpectedOutcome: "Expected Outcome",
    executiveActionOwner: "Owner",
    priorityNotYetDetermined: "Not yet determined",
    confidenceLevel: "Confidence Level",
    recommendedCompanyInputs: "Recommended Company Inputs",
    executiveAttention: "Executive Attention",
    executiveAttentionImmediate: "Needs Immediate Attention",
    executiveAttentionMonitor: "Continue Monitoring",
    pendingExecutiveLanguage: "Pending executive language",
    noMissingEvidence: "No missing evidence reported by runtime.",
    noRecommendedCompanyInputs: "No additional company inputs requested by runtime.",
    noFacts: "No verified facts reported by runtime.",
    noWhatChanged: "No trend change reported by runtime.",
    notAvailableFromRuntime: "Not available from runtime output.",
    provideInputPrefix: "Provide",
